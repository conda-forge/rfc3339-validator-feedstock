...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rfc3339-validator-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14717&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rfc3339-validator-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rfc3339-validator` can be installed with:

```
conda install rfc3339-validator
```

It is possible to list all of the versions of `rfc3339-validator` available on your platform with:
